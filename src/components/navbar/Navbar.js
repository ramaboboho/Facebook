...
export default class NavbarComponent extends Component{
    render() {
        ...
        return (
            <Navbar expand="lg" style={style.nav} fixed="top">
                <Navbar.Brand href="#home" style={style.navBrand}><img src="assets/img/facebook.png" width="40px" alt="logo" /></Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        <Form inline>
                            <FormControl type="text" placeholder="Cari di Facebook" className={styles.input} style={{width:"230px"}}/>
                        </Form>
                        <Nav.Link href="#home" style={{marginLeft:"60px"}}>
                        ...
                        <Nav.Link href="#home" style={{ marginLeft: "60px" }}>
                            <img src="assets/img/Fajar.png" alt="rama" width="30px" />
                            Rama Fa...
                        </Nav.Link>
                        <Nav.Link href="#home" style={style.navRight}>
